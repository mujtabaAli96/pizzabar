            ...
            <div className="menu-card-cart">
                <div className="menu-item">
                    <div className="cart-img">
                        <img width={"100px"} height={"140px"} style={{borderRadius:"12px"}} src={image1}/>
                    </div>
                    <div className="menu-description-cart">
                        <div>Salmón braseado</div>
                        ...
                        <div className="add-cart-count">
                            ...
                            <h2 style={{padding:"0 0.5rem"}}>1</h2> 
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 4V20" stroke="white" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M20 12H4" stroke="white" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                        </div>
                    </div>
                </div>
            </div>
