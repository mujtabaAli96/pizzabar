...
export default function Menu({videoData,setType}:appProps){
    const { menu,selectedMenu } = useContext(DataContext)

    return(
        <div className="mobile-responsive">
            <div style={{display:"flex",flexDirection:"row" , zIndex:"1", color:"#00a99d", position:"absolute",width:"100%", justifyContent:"space-around",height:"90px",alignItems: "center"}}>
            ...
            <div style={{paddingTop:"6rem",overflow:"scroll",height:"80dvh"}}>
                {
                            ...
                            <div className="menu-item">
                                ...
                                <div className="menu-description">
                                    ...
                                    <div className="add-cart">
                                        <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path clipRule="evenodd" d="M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18Z" stroke="#fff" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M12 7v10M17 12H7" stroke="#fff" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                                    </div>
                                </div>
                            </div>
                        </div>
