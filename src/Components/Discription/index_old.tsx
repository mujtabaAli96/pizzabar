        ...
        <div style={{display:"flex",flexDirection:"row" , zIndex:"1", color:"white", position:"absolute",marginTop:"58vh",padding:"1rem 1.5rem", width:"100%", justifyContent:"space-between"}}>
                  ...
                  <div>
                    ...
                    <div style={{paddingTop:"5px"}}>
                      <svg width="35" height="35" fill="#00A99D" xmlns="http://www.w3.org/2000/svg"><path clipRule="evenodd" d="M12 21a9 9 0 1 1 0-18 9 9 0 0 1 0 18Z" stroke="#fff" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path><path d="M12 7v10M17 12H7" stroke="#fff" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                    </div>
                    <div style={{paddingTop:"5px"}}>
