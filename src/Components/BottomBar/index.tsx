...
export default function BottomBar({setType,changeMenu,selectedMenu}:appProps){
    return(
        <div className="onlyMobile" style={{ background: "#121212", width: "100%", position: "fixed", bottom: "0", height: "6dvh", color: "white", display: "flex", alignItems: "center", justifyContent: "space-around", borderRadius: "5px 5px 0 0", padding: "0 5%", zIndex:"2" }}>
